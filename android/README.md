# MoPub, AdMob, Facebook Audience Network
...
그리고 Tracker 적용을 위해서 리스너를 구현하셔야 합니다. [Tracker 가이드 및 AAR 다운로드](https://github.com/tpmn/pointberry-event-tracker-android)
...
그리고 Tracker 적용을 위해서 리스너를 구현하셔야 합니다.
